...
public enum Constantes {
	...
	TIPO_SPOT_FIDELIZADO(5, "FIDELIZADO"), TIPO_SPOT_SMS(4, "SPOT SMS"), TIPO_SPOT_INTERATIVO(2, "SPOT INTERATIVO"), TIPO_SPOT_OPTIN(3, "SPOT OPTIN"), TIPO_SPOT_SIMPLES(1, "SPOT SIMPLES"),
